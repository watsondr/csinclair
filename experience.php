    ...
    <body>
		...
		<section class="section2">
			<h3>Education</h3>
			<ul>
			<li>Bachelor of Business Information Systems via RMIT University (Melbourne) c. 2014</li>
			</ul>
			...
			There was also occasional handling of production support and system testing.
			</p>
			</ul>
